...
switch ($action) {
    ...
    case 'search':
        $resultados = $resources->search(Tools::getValue('texto', ''), Tools::getValue('fecha_desde', ''), Tools::getValue('fecha_hasta', ''), Tools::getValue('boton', ''), Tools::getValue('fecha_eleccion', ''), Tools::getValue('boton1', ''));
        break;
    case 'update':
